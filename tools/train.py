...
# Make sure that project folder is extended in path (./././optirun_ml)
PROJECT_DIR = pathlib.Path(__file__).parent.parent.parent.absolute()
PROJECT_FOLDER_PATH = str(PROJECT_DIR) + "/"
sys.path.extend([PROJECT_FOLDER_PATH])

parentDir = os.getcwd()
sys.path.append(parentDir)
os.environ["PYTORCH_CUDA_ALLOC_CONF"] = "expandable_segments:True"

# sys.path.extend([constants.PROJECT_FOLDER_PATH]) 
